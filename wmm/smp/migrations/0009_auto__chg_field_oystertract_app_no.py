...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OysterTract.app_no'
        db.alter_column('smp_oystertract', 'app_no', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        
        # Changing field 'OysterTract.app_no'
        db.alter_column('smp_oystertract', 'app_no', self.gf('django.db.models.fields.CharField')(max_length=10))
