...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SMPSite.geometry_hash'
        db.add_column('smp_smpsite', 'geometry_hash', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'SMPSite.conservation_score'
        db.add_column('smp_smpsite', 'conservation_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'SMPSite.tidalenergy_score'
        db.add_column('smp_smpsite', 'tidalenergy_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'SMPSite.waveenergy_score'
        db.add_column('smp_smpsite', 'waveenergy_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'SMPSite.windenergy_score'
        db.add_column('smp_smpsite', 'windenergy_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SMPSite.geometry_hash'
        db.delete_column('smp_smpsite', 'geometry_hash')

        # Deleting field 'SMPSite.conservation_score'
        db.delete_column('smp_smpsite', 'conservation_score')

        # Deleting field 'SMPSite.tidalenergy_score'
        db.delete_column('smp_smpsite', 'tidalenergy_score')

        # Deleting field 'SMPSite.waveenergy_score'
        db.delete_column('smp_smpsite', 'waveenergy_score')

        # Deleting field 'SMPSite.windenergy_score'
        db.delete_column('smp_smpsite', 'windenergy_score')
    ...
    models = {
        ...
        'smp.commercialgrowingarea': {
            'Meta': {'object_name': 'CommercialGrowingArea'},
        ...
        'smp.driftcell': {
            'Meta': {'object_name': 'DriftCell'},
            'cell_type': ('django.db.models.fields.CharField', [], {'max_length': '4'}),
            'dc_ds_path': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'dcell_nr': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'geometry': ('django.contrib.gis.db.models.fields.MultiLineStringField', [], {'srid': '32610', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'objectid': ('django.db.models.fields.IntegerField', [], {}),
            'shape_leng': ('django.db.models.fields.FloatField', [], {}),
            'ws_begin_a': ('django.db.models.fields.FloatField', [], {}),
            'ws_end_ad': ('django.db.models.fields.FloatField', [], {}),
            'ws_llid_nr': ('django.db.models.fields.CharField', [], {'max_length': '13', 'null': 'True', 'blank': 'True'})
        },
        'smp.harvestsite': {
            'Meta': {'object_name': 'HarvestSite'},
            'acres': ('django.db.models.fields.FloatField', [], {}),
        ...
        'smp.oysterreserve': {
            'Meta': {'object_name': 'OysterReserve'},
            'area_acres': ('django.db.models.fields.FloatField', [], {}),
            'geometry': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '32610', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shape_area': ('django.db.models.fields.FloatField', [], {}),
            'shape_leng': ('django.db.models.fields.FloatField', [], {})
        ...
        'smp.oystertract': {
            'Meta': {'object_name': 'OysterTract'},
            'app_no': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'area_acres': ('django.db.models.fields.FloatField', [], {}),
            'geometry': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '32610', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orig_id': ('django.db.models.fields.IntegerField', [], {})
        },
        'smp.publicaccess': {
