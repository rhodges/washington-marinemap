...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PublicAccess.owner'
        db.alter_column('smp_publicaccess', 'owner', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))


    def backwards(self, orm):
        
        # Changing field 'PublicAccess.owner'
        db.alter_column('smp_publicaccess', 'owner', self.gf('django.db.models.fields.CharField')(max_length=254))
