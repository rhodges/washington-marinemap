...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OysterTract'
        db.create_table('smp_oystertract', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app_no', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('orig_id', self.gf('django.db.models.fields.IntegerField')()),
            ('area_acres', self.gf('django.db.models.fields.FloatField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=32610, null=True, blank=True)),
        ))
        db.send_create_signal('smp', ['OysterTract'])

        # Adding model 'CommercialGrowingArea'
        db.create_table('smp_commercialgrowingarea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('smp', ['CommercialGrowingArea'])

        # Adding model 'OysterReserve'
        db.create_table('smp_oysterreserve', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shape_leng', self.gf('django.db.models.fields.FloatField')()),
            ('shape_area', self.gf('django.db.models.fields.FloatField')()),
            ('area_acres', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('smp', ['OysterReserve'])

        # Adding model 'HarvestSite'
        db.create_table('smp_harvestsite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('acres', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('smp', ['HarvestSite'])


    def backwards(self, orm):
        
        # Deleting model 'OysterTract'
        db.delete_table('smp_oystertract')

        # Deleting model 'CommercialGrowingArea'
        db.delete_table('smp_commercialgrowingarea')

        # Deleting model 'OysterReserve'
        db.delete_table('smp_oysterreserve')

        # Deleting model 'HarvestSite'
        db.delete_table('smp_harvestsite')
    ...
    models = {
        ...
        'smp.oystertract': {
            ...
            'app_no': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'area_acres': ('django.db.models.fields.FloatField', [], {}),
            'geometry': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '32610', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
