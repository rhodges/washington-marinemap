...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DriftCell'
        db.create_table('smp_driftcell', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objectid', self.gf('django.db.models.fields.IntegerField')()),
            ('ws_llid_nr', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True)),
            ('ws_begin_a', self.gf('django.db.models.fields.FloatField')()),
            ('ws_end_ad', self.gf('django.db.models.fields.FloatField')()),
            ('dc_ds_path', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('dcell_nr', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('cell_type', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('shape_leng', self.gf('django.db.models.fields.FloatField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(srid=32610, null=True, blank=True)),
        ))
        db.send_create_signal('smp', ['DriftCell'])


    def backwards(self, orm):
        
        # Deleting model 'DriftCell'
        db.delete_table('smp_driftcell')
