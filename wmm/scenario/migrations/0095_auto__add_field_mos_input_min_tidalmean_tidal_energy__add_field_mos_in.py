...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MOS.input_min_tidalmean_tidal_energy'
        db.add_column('scenario_mos', 'input_min_tidalmean_tidal_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_max_tidalmean_tidal_energy'
        db.add_column('scenario_mos', 'input_max_tidalmean_tidal_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_min_tidalmax_tidal_energy'
        db.add_column('scenario_mos', 'input_min_tidalmax_tidal_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_max_tidalmax_tidal_energy'
        db.add_column('scenario_mos', 'input_max_tidalmax_tidal_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_min_tidalmean'
        db.add_column('scenario_scenario', 'input_min_tidalmean', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_max_tidalmean'
        db.add_column('scenario_scenario', 'input_max_tidalmean', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_min_tidalmax'
        db.add_column('scenario_scenario', 'input_min_tidalmax', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_max_tidalmax'
        db.add_column('scenario_scenario', 'input_max_tidalmax', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MOS.input_min_tidalmean_tidal_energy'
        db.delete_column('scenario_mos', 'input_min_tidalmean_tidal_energy')

        # Deleting field 'MOS.input_max_tidalmean_tidal_energy'
        db.delete_column('scenario_mos', 'input_max_tidalmean_tidal_energy')

        # Deleting field 'MOS.input_min_tidalmax_tidal_energy'
        db.delete_column('scenario_mos', 'input_min_tidalmax_tidal_energy')

        # Deleting field 'MOS.input_max_tidalmax_tidal_energy'
        db.delete_column('scenario_mos', 'input_max_tidalmax_tidal_energy')

        # Deleting field 'Scenario.input_min_tidalmean'
        db.delete_column('scenario_scenario', 'input_min_tidalmean')

        # Deleting field 'Scenario.input_max_tidalmean'
        db.delete_column('scenario_scenario', 'input_max_tidalmean')

        # Deleting field 'Scenario.input_min_tidalmax'
        db.delete_column('scenario_scenario', 'input_min_tidalmax')

        # Deleting field 'Scenario.input_max_tidalmax'
        db.delete_column('scenario_scenario', 'input_max_tidalmax')
