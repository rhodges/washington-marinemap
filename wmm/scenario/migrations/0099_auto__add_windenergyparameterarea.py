...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WindEnergyParameterArea'
        db.create_table('scenario_windenergyparameterarea', (
        ...
        db.send_create_signal('scenario', ['WindEnergyParameterArea'])


    def backwards(self, orm):
        
        # Deleting model 'WindEnergyParameterArea'
        db.delete_table('scenario_windenergyparameterarea')
