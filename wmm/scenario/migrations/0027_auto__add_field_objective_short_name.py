...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Objective.short_name'
        db.add_column('scenario_objective', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Objective.short_name'
        db.delete_column('scenario_objective', 'short_name')
