...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('scenario_scenario', 'description')

        # Adding field 'MultiObjectiveScenario.description'
        db.add_column('scenario_multiobjectivescenario', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'MultiObjectiveScenario.support_file'
        db.add_column('scenario_multiobjectivescenario', 'support_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Removing M2M table for field input_scenarios on 'MultiObjectiveScenario'
        db.delete_table('scenario_multiobjectivescenario_input_scenarios')
    ...
    def backwards(self, orm):
        ...
        db.add_column('scenario_scenario', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'MultiObjectiveScenario.description'
        db.delete_column('scenario_multiobjectivescenario', 'description')

        # Deleting field 'MultiObjectiveScenario.support_file'
        db.delete_column('scenario_multiobjectivescenario', 'support_file')

        # Adding M2M table for field input_scenarios on 'MultiObjectiveScenario'
        db.create_table('scenario_multiobjectivescenario_input_scenarios', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('multiobjectivescenario', models.ForeignKey(orm['scenario.multiobjectivescenario'], null=False)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False))
        ))
        db.create_unique('scenario_multiobjectivescenario_input_scenarios', ['multiobjectivescenario_id', 'scenario_id'])
