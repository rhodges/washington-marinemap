...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WindParameter.short_name'
        db.delete_column('scenario_windparameter', 'short_name')

        # Deleting field 'WindParameter.name'
        db.delete_column('scenario_windparameter', 'name')
        ...
        # Deleting field 'ConservationParameter.short_name'
        db.delete_column('scenario_conservationparameter', 'short_name')

        # Deleting field 'ConservationParameter.name'
        db.delete_column('scenario_conservationparameter', 'name')
        ...
        # Deleting field 'DevelopmentParameter.short_name'
        db.delete_column('scenario_developmentparameter', 'short_name')

        # Deleting field 'DevelopmentParameter.name'
        db.delete_column('scenario_developmentparameter', 'name')
        ...
        # Deleting field 'TidalParameter.short_name'
        db.delete_column('scenario_tidalparameter', 'short_name')

        # Deleting field 'TidalParameter.name'
        db.delete_column('scenario_tidalparameter', 'name')
        ...
        # Adding field 'Parameter.short_name'
        db.add_column('scenario_parameter', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Deleting field 'ShellfishParameter.short_name'
        db.delete_column('scenario_shellfishparameter', 'short_name')

        # Deleting field 'ShellfishParameter.name'
        db.delete_column('scenario_shellfishparameter', 'name')
        ...
        # Deleting field 'FishingParameter.short_name'
        db.delete_column('scenario_fishingparameter', 'short_name')

        # Deleting field 'FishingParameter.name'
        db.delete_column('scenario_fishingparameter', 'name')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'WindParameter.short_name'
        db.add_column('scenario_windparameter', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Adding field 'WindParameter.name'
        db.add_column('scenario_windparameter', 'name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Removing M2M table for field parameters on 'WindParameter'
        db.delete_table('scenario_windparameter_parameters')

        # Adding field 'ConservationParameter.short_name'
        db.add_column('scenario_conservationparameter', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Adding field 'ConservationParameter.name'
        db.add_column('scenario_conservationparameter', 'name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)
        ...
        # Adding field 'DevelopmentParameter.short_name'
        db.add_column('scenario_developmentparameter', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Adding field 'DevelopmentParameter.name'
        db.add_column('scenario_developmentparameter', 'name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Removing M2M table for field parameters on 'DevelopmentParameter'
        db.delete_table('scenario_developmentparameter_parameters')

        # Adding field 'TidalParameter.short_name'
        db.add_column('scenario_tidalparameter', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Adding field 'TidalParameter.name'
        db.add_column('scenario_tidalparameter', 'name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Removing M2M table for field parameters on 'TidalParameter'
        db.delete_table('scenario_tidalparameter_parameters')

        # Deleting field 'Parameter.short_name'
        db.delete_column('scenario_parameter', 'short_name')

        # Adding field 'ShellfishParameter.short_name'
        db.add_column('scenario_shellfishparameter', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Adding field 'ShellfishParameter.name'
        db.add_column('scenario_shellfishparameter', 'name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Removing M2M table for field parameters on 'ShellfishParameter'
        db.delete_table('scenario_shellfishparameter_parameters')

        # Adding field 'FishingParameter.short_name'
        db.add_column('scenario_fishingparameter', 'short_name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)

        # Adding field 'FishingParameter.name'
        db.add_column('scenario_fishingparameter', 'name', self.gf('django.db.models.fields.CharField')(default='need_to_populate', max_length=70), keep_default=False)
    ...
    models = {
        ...
        'scenario.conservationparameter': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parameters': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.Parameter']", 'null': 'True', 'blank': 'True'})
        },
