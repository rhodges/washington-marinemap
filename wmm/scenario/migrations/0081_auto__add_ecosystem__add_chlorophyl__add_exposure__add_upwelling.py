...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ecosystem'
        db.create_table('scenario_ecosystem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['Ecosystem'])

        # Adding model 'Chlorophyl'
        db.create_table('scenario_chlorophyl', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['Chlorophyl'])

        # Adding model 'Exposure'
        db.create_table('scenario_exposure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['Exposure'])

        # Adding model 'Upwelling'
        db.create_table('scenario_upwelling', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['Upwelling'])

        # Adding M2M table for field input_upwelling_water_column_conservation on 'MOS'
        db.create_table('scenario_mos_input_upwelling_water_column_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('upwelling', models.ForeignKey(orm['scenario.upwelling'], null=False))
        ))
        db.create_unique('scenario_mos_input_upwelling_water_column_conservation', ['mos_id', 'upwelling_id'])

        # Adding M2M table for field input_chlorophyl_water_column_conservation on 'MOS'
        db.create_table('scenario_mos_input_chlorophyl_water_column_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('chlorophyl', models.ForeignKey(orm['scenario.chlorophyl'], null=False))
        ))
        db.create_unique('scenario_mos_input_chlorophyl_water_column_conservation', ['mos_id', 'chlorophyl_id'])

        # Adding M2M table for field input_upwelling on 'Scenario'
        db.create_table('scenario_scenario_input_upwelling', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('upwelling', models.ForeignKey(orm['scenario.upwelling'], null=False))
        ))
        db.create_unique('scenario_scenario_input_upwelling', ['scenario_id', 'upwelling_id'])

        # Adding M2M table for field input_chlorophyl on 'Scenario'
        db.create_table('scenario_scenario_input_chlorophyl', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('chlorophyl', models.ForeignKey(orm['scenario.chlorophyl'], null=False))
        ))
        db.create_unique('scenario_scenario_input_chlorophyl', ['scenario_id', 'chlorophyl_id'])


    def backwards(self, orm):
        
        # Deleting model 'Ecosystem'
        db.delete_table('scenario_ecosystem')

        # Deleting model 'Chlorophyl'
        db.delete_table('scenario_chlorophyl')

        # Deleting model 'Exposure'
        db.delete_table('scenario_exposure')

        # Deleting model 'Upwelling'
        db.delete_table('scenario_upwelling')

        # Removing M2M table for field input_upwelling_water_column_conservation on 'MOS'
        db.delete_table('scenario_mos_input_upwelling_water_column_conservation')

        # Removing M2M table for field input_chlorophyl_water_column_conservation on 'MOS'
        db.delete_table('scenario_mos_input_chlorophyl_water_column_conservation')

        # Removing M2M table for field input_upwelling on 'Scenario'
        db.delete_table('scenario_scenario_input_upwelling')

        # Removing M2M table for field input_chlorophyl on 'Scenario'
        db.delete_table('scenario_scenario_input_chlorophyl')
