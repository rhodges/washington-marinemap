...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field input_depth_class on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class', (
        ...
        db.create_unique('scenario_scenario_input_depth_class', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology', ['scenario_id', 'geomorphology_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field input_depth_class on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class')

        # Removing M2M table for field input_geomorphology on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology')
