...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MOS.input_min_wavesummer_wave_energy'
        db.add_column('scenario_mos', 'input_min_wavesummer_wave_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_max_wavesummer_wave_energy'
        db.add_column('scenario_mos', 'input_max_wavesummer_wave_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_min_wavewinter_wave_energy'
        db.add_column('scenario_mos', 'input_min_wavewinter_wave_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_max_wavewinter_wave_energy'
        db.add_column('scenario_mos', 'input_max_wavewinter_wave_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_min_wavesummer'
        db.add_column('scenario_scenario', 'input_min_wavesummer', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_max_wavesummer'
        db.add_column('scenario_scenario', 'input_max_wavesummer', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_min_wavewinter'
        db.add_column('scenario_scenario', 'input_min_wavewinter', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_max_wavewinter'
        db.add_column('scenario_scenario', 'input_max_wavewinter', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MOS.input_min_wavesummer_wave_energy'
        db.delete_column('scenario_mos', 'input_min_wavesummer_wave_energy')

        # Deleting field 'MOS.input_max_wavesummer_wave_energy'
        db.delete_column('scenario_mos', 'input_max_wavesummer_wave_energy')

        # Deleting field 'MOS.input_min_wavewinter_wave_energy'
        db.delete_column('scenario_mos', 'input_min_wavewinter_wave_energy')

        # Deleting field 'MOS.input_max_wavewinter_wave_energy'
        db.delete_column('scenario_mos', 'input_max_wavewinter_wave_energy')

        # Deleting field 'Scenario.input_min_wavesummer'
        db.delete_column('scenario_scenario', 'input_min_wavesummer')

        # Deleting field 'Scenario.input_max_wavesummer'
        db.delete_column('scenario_scenario', 'input_max_wavesummer')

        # Deleting field 'Scenario.input_min_wavewinter'
        db.delete_column('scenario_scenario', 'input_min_wavewinter')

        # Deleting field 'Scenario.input_max_wavewinter'
        db.delete_column('scenario_scenario', 'input_max_wavewinter')
