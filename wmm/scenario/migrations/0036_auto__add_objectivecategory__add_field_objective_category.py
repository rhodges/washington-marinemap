...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'scenario.objective': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.ObjectiveCategory']", 'null': 'True', 'blank': 'True'}),
        ...
        'scenario.objectivecategory': {
            'Meta': {'object_name': 'ObjectiveCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '70'})
        },
        'scenario.parameter': {
