...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scenario.input_substrate'
        db.delete_column('scenario_scenario', 'input_substrate_id')

        # Adding field 'Scenario.input_substrate_tidal_energy'
        db.add_column('scenario_scenario', 'input_substrate_tidal_energy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.TidalEnergySubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_wave_energy'
        db.add_column('scenario_scenario', 'input_substrate_wave_energy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.WaveEnergySubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_wind_energy'
        db.add_column('scenario_scenario', 'input_substrate_wind_energy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.WindEnergySubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_offshore_conservation'
        db.add_column('scenario_scenario', 'input_substrate_offshore_conservation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.OffshoreConservationSubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_nearshore_conservation'
        db.add_column('scenario_scenario', 'input_substrate_nearshore_conservation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.NearshoreConservationSubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_water_column_conservation'
        db.add_column('scenario_scenario', 'input_substrate_water_column_conservation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.WaterColumnConservationSubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_shoreside_development'
        db.add_column('scenario_scenario', 'input_substrate_shoreside_development', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.ShoresideDevelopmentSubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_shellfish_aquaculture'
        db.add_column('scenario_scenario', 'input_substrate_shellfish_aquaculture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.ShellfishAquacultureSubstrate'], null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_substrate_offshore_fishing'
        db.add_column('scenario_scenario', 'input_substrate_offshore_fishing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.OffshoreFishingSubstrate'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Scenario.input_substrate'
        db.add_column('scenario_scenario', 'input_substrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'Scenario.input_substrate_tidal_energy'
        db.delete_column('scenario_scenario', 'input_substrate_tidal_energy_id')

        # Deleting field 'Scenario.input_substrate_wave_energy'
        db.delete_column('scenario_scenario', 'input_substrate_wave_energy_id')

        # Deleting field 'Scenario.input_substrate_wind_energy'
        db.delete_column('scenario_scenario', 'input_substrate_wind_energy_id')

        # Deleting field 'Scenario.input_substrate_offshore_conservation'
        db.delete_column('scenario_scenario', 'input_substrate_offshore_conservation_id')

        # Deleting field 'Scenario.input_substrate_nearshore_conservation'
        db.delete_column('scenario_scenario', 'input_substrate_nearshore_conservation_id')

        # Deleting field 'Scenario.input_substrate_water_column_conservation'
        db.delete_column('scenario_scenario', 'input_substrate_water_column_conservation_id')

        # Deleting field 'Scenario.input_substrate_shoreside_development'
        db.delete_column('scenario_scenario', 'input_substrate_shoreside_development_id')

        # Deleting field 'Scenario.input_substrate_shellfish_aquaculture'
        db.delete_column('scenario_scenario', 'input_substrate_shellfish_aquaculture_id')

        # Deleting field 'Scenario.input_substrate_offshore_fishing'
        db.delete_column('scenario_scenario', 'input_substrate_offshore_fishing_id')
    ...
    models = {
        ...
        'scenario.scenario': {
            ...
            'input_substrate_nearshore_conservation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.NearshoreConservationSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_offshore_conservation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.OffshoreConservationSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_offshore_fishing': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.OffshoreFishingSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_shellfish_aquaculture': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.ShellfishAquacultureSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_shoreside_development': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.ShoresideDevelopmentSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_tidal_energy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.TidalEnergySubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_water_column_conservation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.WaterColumnConservationSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_wave_energy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.WaveEnergySubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_wind_energy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.WindEnergySubstrate']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'255'"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
