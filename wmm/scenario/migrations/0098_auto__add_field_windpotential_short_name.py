...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WindPotential.short_name'
        db.add_column('scenario_windpotential', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WindPotential.short_name'
        db.delete_column('scenario_windpotential', 'short_name')
