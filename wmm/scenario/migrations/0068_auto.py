...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field input_depth_class_tidal_energy on 'MOS'
        db.create_table('scenario_mos_input_depth_class_tidal_energy', (
        ...
        db.create_unique('scenario_mos_input_depth_class_tidal_energy', ['mos_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_tidal_energy on 'MOS'
        db.create_table('scenario_mos_input_geomorphology_tidal_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_mos_input_geomorphology_tidal_energy', ['mos_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_wind_energy on 'MOS'
        db.create_table('scenario_mos_input_depth_class_wind_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_mos_input_depth_class_wind_energy', ['mos_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_wind_energy on 'MOS'
        db.create_table('scenario_mos_input_geomorphology_wind_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_mos_input_geomorphology_wind_energy', ['mos_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_wave_energy on 'MOS'
        db.create_table('scenario_mos_input_depth_class_wave_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_mos_input_depth_class_wave_energy', ['mos_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_wave_energy on 'MOS'
        db.create_table('scenario_mos_input_geomorphology_wave_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_mos_input_geomorphology_wave_energy', ['mos_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_offshore_conservation on 'MOS'
        db.create_table('scenario_mos_input_depth_class_offshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_mos_input_depth_class_offshore_conservation', ['mos_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_offshore_conservation on 'MOS'
        db.create_table('scenario_mos_input_geomorphology_offshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_mos_input_geomorphology_offshore_conservation', ['mos_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_nearshore_conservation on 'MOS'
        db.create_table('scenario_mos_input_depth_class_nearshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_mos_input_depth_class_nearshore_conservation', ['mos_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_nearshore_conservation on 'MOS'
        db.create_table('scenario_mos_input_geomorphology_nearshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_mos_input_geomorphology_nearshore_conservation', ['mos_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_water_column_conservation on 'MOS'
        db.create_table('scenario_mos_input_depth_class_water_column_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_mos_input_depth_class_water_column_conservation', ['mos_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_water_column_conservation on 'MOS'
        db.create_table('scenario_mos_input_geomorphology_water_column_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_mos_input_geomorphology_water_column_conservation', ['mos_id', 'geomorphology_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field input_depth_class_tidal_energy on 'MOS'
        db.delete_table('scenario_mos_input_depth_class_tidal_energy')

        # Removing M2M table for field input_geomorphology_tidal_energy on 'MOS'
        db.delete_table('scenario_mos_input_geomorphology_tidal_energy')

        # Removing M2M table for field input_depth_class_wind_energy on 'MOS'
        db.delete_table('scenario_mos_input_depth_class_wind_energy')

        # Removing M2M table for field input_geomorphology_wind_energy on 'MOS'
        db.delete_table('scenario_mos_input_geomorphology_wind_energy')

        # Removing M2M table for field input_depth_class_wave_energy on 'MOS'
        db.delete_table('scenario_mos_input_depth_class_wave_energy')

        # Removing M2M table for field input_geomorphology_wave_energy on 'MOS'
        db.delete_table('scenario_mos_input_geomorphology_wave_energy')

        # Removing M2M table for field input_depth_class_offshore_conservation on 'MOS'
        db.delete_table('scenario_mos_input_depth_class_offshore_conservation')

        # Removing M2M table for field input_geomorphology_offshore_conservation on 'MOS'
        db.delete_table('scenario_mos_input_geomorphology_offshore_conservation')

        # Removing M2M table for field input_depth_class_nearshore_conservation on 'MOS'
        db.delete_table('scenario_mos_input_depth_class_nearshore_conservation')

        # Removing M2M table for field input_geomorphology_nearshore_conservation on 'MOS'
        db.delete_table('scenario_mos_input_geomorphology_nearshore_conservation')

        # Removing M2M table for field input_depth_class_water_column_conservation on 'MOS'
        db.delete_table('scenario_mos_input_depth_class_water_column_conservation')

        # Removing M2M table for field input_geomorphology_water_column_conservation on 'MOS'
        db.delete_table('scenario_mos_input_geomorphology_water_column_conservation')
    ...
    models = {
        ...
        'scenario.mos': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_depth_class_nearshore_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSNearshoreConservationDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            ...
            'input_depth_class_offshore_fishing': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSOffshoreFishingDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            'input_depth_class_shellfish_aquaculture': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSShellfishAquacultureDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            'input_depth_class_shoreside_development': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSShoresideDevelopmentDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            'input_depth_class_tidal_energy': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSTidalEnergyDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            'input_depth_class_water_column_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSWaterColumnConservationDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            'input_depth_class_wave_energy': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSWaveEnergyDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            'input_depth_class_wind_energy': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSWindEnergyDepthClass'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.DepthClass']"}),
            ...
            'input_geomorphology_nearshore_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSNearshoreConservationGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
            ...
            'input_geomorphology_offshore_fishing': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSOffshoreFishingGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
            'input_geomorphology_shellfish_aquaculture': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSShellfishAquacultureGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
            'input_geomorphology_shoreside_development': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSShoresideDevelopmentGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
            'input_geomorphology_tidal_energy': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSTidalEnergyGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
            'input_geomorphology_water_column_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSWaterColumnConservationGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
            'input_geomorphology_wave_energy': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSWaveEnergyGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
            'input_geomorphology_wind_energy': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'MOSWindEnergyGeomorphology'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['scenario.Geomorphology']"}),
