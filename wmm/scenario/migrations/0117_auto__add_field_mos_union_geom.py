...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MOS.union_geom'
        db.add_column('scenario_mos', 'union_geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=32610, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MOS.union_geom'
        db.delete_column('scenario_mos', 'union_geom')
    ...
    models = {
        ...
        'scenario.mos': {
            ...
            'union_geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '32610', 'null': 'True', 'blank': 'True'}),
