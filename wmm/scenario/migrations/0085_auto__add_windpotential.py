...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WindPotential'
        db.create_table('scenario_windpotential', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('density', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('speed', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['WindPotential'])

        # Adding M2M table for field input_wind_potential_wind_energy on 'MOS'
        db.create_table('scenario_mos_input_wind_potential_wind_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('windpotential', models.ForeignKey(orm['scenario.windpotential'], null=False))
        ))
        db.create_unique('scenario_mos_input_wind_potential_wind_energy', ['mos_id', 'windpotential_id'])

        # Adding M2M table for field input_wind_potential on 'Scenario'
        db.create_table('scenario_scenario_input_wind_potential', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('windpotential', models.ForeignKey(orm['scenario.windpotential'], null=False))
        ))
        db.create_unique('scenario_scenario_input_wind_potential', ['scenario_id', 'windpotential_id'])


    def backwards(self, orm):
        
        # Deleting model 'WindPotential'
        db.delete_table('scenario_windpotential')

        # Removing M2M table for field input_wind_potential_wind_energy on 'MOS'
        db.delete_table('scenario_mos_input_wind_potential_wind_energy')

        # Removing M2M table for field input_wind_potential on 'Scenario'
        db.delete_table('scenario_scenario_input_wind_potential')
