...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.input_max_depth'
        db.alter_column('scenario_scenario', 'input_max_depth', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_min_depth'
        db.alter_column('scenario_scenario', 'input_min_depth', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_dist_shore'
        db.alter_column('scenario_scenario', 'input_dist_shore', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_dist_port'
        db.alter_column('scenario_scenario', 'input_dist_port', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Scenario.input_max_depth'
        db.alter_column('scenario_scenario', 'input_max_depth', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Scenario.input_min_depth'
        db.alter_column('scenario_scenario', 'input_min_depth', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Scenario.input_dist_shore'
        db.alter_column('scenario_scenario', 'input_dist_shore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Scenario.input_dist_port'
        db.alter_column('scenario_scenario', 'input_dist_port', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'scenario.scenario': {
            ...
            'input_substrate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.Substrate']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'255'"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
