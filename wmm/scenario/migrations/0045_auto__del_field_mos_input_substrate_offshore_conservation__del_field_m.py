...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('scenario_mos', 'input_substrate_offshore_conservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='OffshoreConservationSubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_shellfish_aquaculture'
        db.add_column('scenario_mos', 'input_substrate_shellfish_aquaculture', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ShellfishAquacultureSubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_tidal_energy'
        db.add_column('scenario_mos', 'input_substrate_tidal_energy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='TidalEnergySubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_wave_energy'
        db.add_column('scenario_mos', 'input_substrate_wave_energy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='WaveEnergySubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_nearshore_conservation'
        db.add_column('scenario_mos', 'input_substrate_nearshore_conservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='NearshoreConservationSubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_shoreside_development'
        db.add_column('scenario_mos', 'input_substrate_shoreside_development', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ShoresideDevelopmentSubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_wind_energy'
        db.add_column('scenario_mos', 'input_substrate_wind_energy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='WindEnergySubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_offshore_fishing'
        db.add_column('scenario_mos', 'input_substrate_offshore_fishing', self.gf('django.db.models.fields.related.ForeignKey')(related_name='OffshoreFishingSubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)

        # Adding field 'MOS.input_substrate_water_column_conservation'
        db.add_column('scenario_mos', 'input_substrate_water_column_conservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='WaterColumnConservationSubstrate', null=True, to=orm['scenario.Substrate'], blank=True), keep_default=False)
