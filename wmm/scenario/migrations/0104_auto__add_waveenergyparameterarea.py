...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WaveEnergyParameterArea'
        db.create_table('scenario_waveenergyparameterarea', (
        ...
        db.send_create_signal('scenario', ['WaveEnergyParameterArea'])


    def backwards(self, orm):
        
        # Deleting model 'WaveEnergyParameterArea'
        db.delete_table('scenario_waveenergyparameterarea')
