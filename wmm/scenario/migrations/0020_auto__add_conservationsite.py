...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scenario_conservationsite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scenario_conservationsite_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scenario_conservationsite_related', null=True, to=orm['contenttypes.ContentType'])),
        ...
        db.send_create_signal('scenario', ['ConservationSite'])

        # Adding M2M table for field sharing_groups on 'ConservationSite'
        db.create_table('scenario_conservationsite_sharing_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('conservationsite', models.ForeignKey(orm['scenario.conservationsite'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('scenario_conservationsite_sharing_groups', ['conservationsite_id', 'group_id'])


    def backwards(self, orm):
        
        # Deleting model 'ConservationSite'
        db.delete_table('scenario_conservationsite')

        # Removing M2M table for field sharing_groups on 'ConservationSite'
        db.delete_table('scenario_conservationsite_sharing_groups')
