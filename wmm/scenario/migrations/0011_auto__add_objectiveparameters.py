...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ObjectiveParameters'
        db.create_table('scenario_objectiveparameters', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Objective'])),
            ('parameter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Parameter'])),
        ))
        db.send_create_signal('scenario', ['ObjectiveParameters'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ObjectiveParameters'
        db.delete_table('scenario_objectiveparameters')
    ...
    models = {
        ...
        'scenario.objective': {
            ...
            'parameters': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scenario.Parameter']", 'through': "orm['scenario.ObjectiveParameters']", 'symmetrical': 'False'})
        },
        'scenario.objectiveparameters': {
            'Meta': {'object_name': 'ObjectiveParameters'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'objective': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.Objective']"}),
            'parameter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.Parameter']"})
        },
        'scenario.parameter': {
            'Meta': {'object_name': 'Parameter'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '70'}),
            'objectives': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scenario.Objective']", 'through': "orm['scenario.ObjectiveParameters']", 'symmetrical': 'False'})
        },
        'scenario.poi': {
