...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.output_mapcalc'
        db.alter_column('scenario_scenario', 'output_mapcalc', self.gf('django.db.models.fields.CharField')(max_length=720, null=True))


    def backwards(self, orm):
        
        # Changing field 'Scenario.output_mapcalc'
        db.alter_column('scenario_scenario', 'output_mapcalc', self.gf('django.db.models.fields.CharField')(max_length=360, null=True))
