...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Substrate.mud'
        db.delete_column('scenario_substrate', 'mud')

        # Deleting field 'Substrate.sand'
        db.delete_column('scenario_substrate', 'sand')

        # Deleting field 'Substrate.rocky'
        db.delete_column('scenario_substrate', 'rocky')

        # Deleting field 'Substrate.island'
        db.delete_column('scenario_substrate', 'island')

        # Deleting field 'Substrate.gravel'
        db.delete_column('scenario_substrate', 'gravel')

        # Deleting field 'Substrate.soft'
        db.delete_column('scenario_substrate', 'soft')

        # Adding field 'Substrate.name'
        db.add_column('scenario_substrate', 'name', self.gf('django.db.models.fields.CharField')(default='un-named', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Substrate.mud'
        db.add_column('scenario_substrate', 'mud', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Substrate.sand'
        db.add_column('scenario_substrate', 'sand', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Substrate.rocky'
        db.add_column('scenario_substrate', 'rocky', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Substrate.island'
        db.add_column('scenario_substrate', 'island', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Substrate.gravel'
        db.add_column('scenario_substrate', 'gravel', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Substrate.soft'
        db.add_column('scenario_substrate', 'soft', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Substrate.name'
        db.delete_column('scenario_substrate', 'name')
