...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scenario_windenergysite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scenario_windenergysite_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scenario_windenergysite_related', null=True, to=orm['contenttypes.ContentType'])),
        ...
        db.send_create_signal('scenario', ['WindEnergySite'])

        # Adding M2M table for field sharing_groups on 'WindEnergySite'
        db.create_table('scenario_windenergysite_sharing_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('windenergysite', models.ForeignKey(orm['scenario.windenergysite'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('scenario_windenergysite_sharing_groups', ['windenergysite_id', 'group_id'])


    def backwards(self, orm):
        
        # Deleting model 'WindEnergySite'
        db.delete_table('scenario_windenergysite')

        # Removing M2M table for field sharing_groups on 'WindEnergySite'
        db.delete_table('scenario_windenergysite_sharing_groups')
