...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.input_objective'
        db.add_column('scenario_scenario', 'input_objective', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['scenario.Objective']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Scenario.input_objective'
        db.delete_column('scenario_scenario', 'input_objective_id')
