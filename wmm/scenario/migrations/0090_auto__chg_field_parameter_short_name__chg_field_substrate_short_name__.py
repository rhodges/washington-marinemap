...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Parameter.short_name'
        db.alter_column('scenario_parameter', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

        # Changing field 'Substrate.short_name'
        db.alter_column('scenario_substrate', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Objective.short_name'
        db.alter_column('scenario_objective', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

        # Changing field 'Category.short_name'
        db.alter_column('scenario_category', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))


    def backwards(self, orm):
        
        # Changing field 'Parameter.short_name'
        db.alter_column('scenario_parameter', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Substrate.short_name'
        db.alter_column('scenario_substrate', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Objective.short_name'
        db.alter_column('scenario_objective', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Category.short_name'
        db.alter_column('scenario_category', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=70))
