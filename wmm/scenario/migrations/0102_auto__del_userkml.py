...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('scenario_userkml', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scenario_userkml_related', null=True, to=orm['contenttypes.ContentType'], blank=True)),
