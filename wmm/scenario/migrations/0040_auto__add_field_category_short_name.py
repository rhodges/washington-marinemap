...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scenario_category', 'short_name', self.gf('django.db.models.fields.CharField')(default='short name not specified', max_length=70), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.short_name'
        db.delete_column('scenario_category', 'short_name')
