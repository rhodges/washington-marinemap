...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.output_report'
        db.add_column('scenario_scenario', 'output_report', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.output_report'
        db.delete_column('scenario_scenario', 'output_report')
