...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field input_objectives on 'MOS'
        db.create_table('scenario_mos_input_objectives', (
        ...
        db.create_unique('scenario_mos_input_objectives', ['mos_id', 'objective_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field input_objectives on 'MOS'
        db.delete_table('scenario_mos_input_objectives')
