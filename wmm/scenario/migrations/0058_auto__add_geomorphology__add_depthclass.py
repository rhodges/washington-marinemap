...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Geomorphology'
        db.create_table('scenario_geomorphology', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['Geomorphology'])

        # Adding model 'DepthClass'
        db.create_table('scenario_depthclass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['DepthClass'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Geomorphology'
        db.delete_table('scenario_geomorphology')

        # Deleting model 'DepthClass'
        db.delete_table('scenario_depthclass')
