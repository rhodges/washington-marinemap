...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TidalEnergyParameterArea'
        db.create_table('scenario_tidalenergyparameterarea', (
        ...
        db.send_create_signal('scenario', ['TidalEnergyParameterArea'])


    def backwards(self, orm):
        
        # Deleting model 'TidalEnergyParameterArea'
        db.delete_table('scenario_tidalenergyparameterarea')
