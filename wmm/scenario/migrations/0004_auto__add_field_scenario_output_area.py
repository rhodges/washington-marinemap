...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.output_area'
        db.add_column('scenario_scenario', 'output_area', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.output_area'
        db.delete_column('scenario_scenario', 'output_area')
