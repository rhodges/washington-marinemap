...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Geomorphology.short_name'
        db.add_column('scenario_geomorphology', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'DepthClass.short_name'
        db.add_column('scenario_depthclass', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Geomorphology.short_name'
        db.delete_column('scenario_geomorphology', 'short_name')

        # Deleting field 'DepthClass.short_name'
        db.delete_column('scenario_depthclass', 'short_name')
