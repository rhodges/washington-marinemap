...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PelagicConservationParameterArea'
        db.create_table('scenario_pelagicconservationparameterarea', (
        ...
        db.send_create_signal('scenario', ['PelagicConservationParameterArea'])

        # Adding model 'PelagicConservationParameter'
        db.create_table('scenario_pelagicconservationparameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parameter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Parameter'], null=True, blank=True)),
        ))
        db.send_create_signal('scenario', ['PelagicConservationParameter'])

        # Adding field 'Chlorophyl.short_name'
        db.add_column('scenario_chlorophyl', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'Upwelling.short_name'
        db.add_column('scenario_upwelling', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PelagicConservationParameterArea'
        db.delete_table('scenario_pelagicconservationparameterarea')

        # Deleting model 'PelagicConservationParameter'
        db.delete_table('scenario_pelagicconservationparameter')

        # Deleting field 'Chlorophyl.short_name'
        db.delete_column('scenario_chlorophyl', 'short_name')

        # Deleting field 'Upwelling.short_name'
        db.delete_column('scenario_upwelling', 'short_name')
    ...
    models = {
        ...
        'scenario.mos': {
            ...
            'input_parameters_water_column_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scenario.PelagicConservationParameter']", 'symmetrical': 'False'}),
