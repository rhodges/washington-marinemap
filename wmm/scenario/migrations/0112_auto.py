...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field input_parameters_pelagic_conservation on 'MOS'
        db.create_table('scenario_mos_input_parameters_pelagic_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('pelagicconservationparameter', models.ForeignKey(orm['scenario.pelagicconservationparameter'], null=False))
        ))
        db.create_unique('scenario_mos_input_parameters_pelagic_conservation', ['mos_id', 'pelagicconservationparameter_id'])

        # Adding M2M table for field input_upwelling_pelagic_conservation on 'MOS'
        db.create_table('scenario_mos_input_upwelling_pelagic_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('upwelling', models.ForeignKey(orm['scenario.upwelling'], null=False))
        ))
        db.create_unique('scenario_mos_input_upwelling_pelagic_conservation', ['mos_id', 'upwelling_id'])

        # Adding M2M table for field input_chlorophyl_pelagic_conservation on 'MOS'
        db.create_table('scenario_mos_input_chlorophyl_pelagic_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('chlorophyl', models.ForeignKey(orm['scenario.chlorophyl'], null=False))
        ))
        db.create_unique('scenario_mos_input_chlorophyl_pelagic_conservation', ['mos_id', 'chlorophyl_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_unique('scenario_mos_input_parameters_water_column_conservation', ['mos_id', 'pelagicconservationparameter_id'])

        # Removing M2M table for field input_parameters_pelagic_conservation on 'MOS'
        db.delete_table('scenario_mos_input_parameters_pelagic_conservation')

        # Removing M2M table for field input_upwelling_pelagic_conservation on 'MOS'
        db.delete_table('scenario_mos_input_upwelling_pelagic_conservation')

        # Removing M2M table for field input_chlorophyl_pelagic_conservation on 'MOS'
        db.delete_table('scenario_mos_input_chlorophyl_pelagic_conservation')
