...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FishingSubstrate.substrate2'
        db.delete_column('scenario_fishingsubstrate', 'substrate2_id')

        # Adding field 'FishingSubstrate.substrate'
        db.add_column('scenario_fishingsubstrate', 'substrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'ConservationSubstrate.substrate2'
        db.delete_column('scenario_conservationsubstrate', 'substrate2_id')

        # Adding field 'ConservationSubstrate.substrate'
        db.add_column('scenario_conservationsubstrate', 'substrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'WindSubstrate.substrate2'
        db.delete_column('scenario_windsubstrate', 'substrate2_id')

        # Adding field 'WindSubstrate.substrate'
        db.add_column('scenario_windsubstrate', 'substrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'TidalSubstrate.substrate2'
        db.delete_column('scenario_tidalsubstrate', 'substrate2_id')

        # Adding field 'TidalSubstrate.substrate'
        db.add_column('scenario_tidalsubstrate', 'substrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'ShellfishSubstrate.substrate2'
        db.delete_column('scenario_shellfishsubstrate', 'substrate2_id')

        # Adding field 'ShellfishSubstrate.substrate'
        db.add_column('scenario_shellfishsubstrate', 'substrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'DevelopmentSubstrate.substrate2'
        db.delete_column('scenario_developmentsubstrate', 'substrate2_id')

        # Adding field 'DevelopmentSubstrate.substrate'
        db.add_column('scenario_developmentsubstrate', 'substrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'FishingSubstrate.substrate2'
        db.add_column('scenario_fishingsubstrate', 'substrate2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'FishingSubstrate.substrate'
        db.delete_column('scenario_fishingsubstrate', 'substrate_id')

        # Adding field 'ConservationSubstrate.substrate2'
        db.add_column('scenario_conservationsubstrate', 'substrate2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'ConservationSubstrate.substrate'
        db.delete_column('scenario_conservationsubstrate', 'substrate_id')

        # Adding field 'WindSubstrate.substrate2'
        db.add_column('scenario_windsubstrate', 'substrate2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'WindSubstrate.substrate'
        db.delete_column('scenario_windsubstrate', 'substrate_id')

        # Adding field 'TidalSubstrate.substrate2'
        db.add_column('scenario_tidalsubstrate', 'substrate2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'TidalSubstrate.substrate'
        db.delete_column('scenario_tidalsubstrate', 'substrate_id')

        # Adding field 'ShellfishSubstrate.substrate2'
        db.add_column('scenario_shellfishsubstrate', 'substrate2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'ShellfishSubstrate.substrate'
        db.delete_column('scenario_shellfishsubstrate', 'substrate_id')

        # Adding field 'DevelopmentSubstrate.substrate2'
        db.add_column('scenario_developmentsubstrate', 'substrate2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Substrate'], null=True, blank=True), keep_default=False)

        # Deleting field 'DevelopmentSubstrate.substrate'
        db.delete_column('scenario_developmentsubstrate', 'substrate_id')
