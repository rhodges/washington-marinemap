...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NearshoreEcosystem.short_name'
        db.add_column('scenario_nearshoreecosystem', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'NearshoreExposure.short_name'
        db.add_column('scenario_nearshoreexposure', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NearshoreEcosystem.short_name'
        db.delete_column('scenario_nearshoreecosystem', 'short_name')

        # Deleting field 'NearshoreExposure.short_name'
        db.delete_column('scenario_nearshoreexposure', 'short_name')
