...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'scenario.scenario': {
            ...
            'input_parameters': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scenario.Parameter']", 'through': "orm['scenario.ScenarioParameters']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'255'"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'scenario.scenarioparameters': {
            'Meta': {'object_name': 'ScenarioParameters'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parameter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.Parameter']"}),
            'scenario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scenario.Scenario']"}),
            'value': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '30'})
        },
        'scenario.substrate': {
