...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Substrate.color'
        db.add_column('scenario_substrate', 'color', self.gf('django.db.models.fields.CharField')(default='778B1A55', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Substrate.color'
        db.delete_column('scenario_substrate', 'color')
