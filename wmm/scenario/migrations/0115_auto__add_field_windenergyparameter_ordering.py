...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WindEnergyParameter.ordering'
        db.add_column('scenario_windenergyparameter', 'ordering', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WindEnergyParameter.ordering'
        db.delete_column('scenario_windenergyparameter', 'ordering')
