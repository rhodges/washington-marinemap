...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.geometry_final'
        db.add_column('scenario_scenario', 'geometry_final', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=32610, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.geometry_final'
        db.delete_column('scenario_scenario', 'geometry_final')
