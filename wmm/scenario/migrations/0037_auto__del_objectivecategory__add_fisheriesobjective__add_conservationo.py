...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ObjectiveCategory'
        db.delete_table('scenario_objectivecategory')

        # Adding model 'FisheriesObjective'
        db.create_table('scenario_fisheriesobjective', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Objective'], null=True, blank=True)),
        ))
        db.send_create_signal('scenario', ['FisheriesObjective'])

        # Adding model 'ConservationObjective'
        db.create_table('scenario_conservationobjective', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Objective'], null=True, blank=True)),
        ))
        db.send_create_signal('scenario', ['ConservationObjective'])

        # Adding model 'DevelopmentObjective'
        db.create_table('scenario_developmentobjective', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Objective'], null=True, blank=True)),
        ))
        db.send_create_signal('scenario', ['DevelopmentObjective'])

        # Adding model 'Category'
        db.create_table('scenario_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=70)),
        ))
        db.send_create_signal('scenario', ['Category'])

        # Adding model 'EnergyObjective'
        db.create_table('scenario_energyobjective', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.Objective'], null=True, blank=True)),
        ))
        db.send_create_signal('scenario', ['EnergyObjective'])

        # Deleting field 'Objective.category'
        db.delete_column('scenario_objective', 'category_id')


    def backwards(self, orm):
        
        # Adding model 'ObjectiveCategory'
        db.create_table('scenario_objectivecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=70)),
        ))
        db.send_create_signal('scenario', ['ObjectiveCategory'])

        # Deleting model 'FisheriesObjective'
        db.delete_table('scenario_fisheriesobjective')

        # Deleting model 'ConservationObjective'
        db.delete_table('scenario_conservationobjective')

        # Deleting model 'DevelopmentObjective'
        db.delete_table('scenario_developmentobjective')

        # Deleting model 'Category'
        db.delete_table('scenario_category')

        # Deleting model 'EnergyObjective'
        db.delete_table('scenario_energyobjective')

        # Adding field 'Objective.category'
        db.add_column('scenario_objective', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenario.ObjectiveCategory'], null=True, blank=True), keep_default=False)
