...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OffshoreConservationParameterArea'
        db.create_table('scenario_offshoreconservationparameterarea', (
        ...
        db.send_create_signal('scenario', ['OffshoreConservationParameterArea'])


    def backwards(self, orm):
        
        # Deleting model 'OffshoreConservationParameterArea'
        db.delete_table('scenario_offshoreconservationparameterarea')
