...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NearshoreSubstrate'
        db.create_table('scenario_nearshoresubstrate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('color', self.gf('django.db.models.fields.CharField')(default='778B1A55', max_length=8)),
        ))
        db.send_create_signal('scenario', ['NearshoreSubstrate'])


    def backwards(self, orm):
        
        # Deleting model 'NearshoreSubstrate'
        db.delete_table('scenario_nearshoresubstrate')
