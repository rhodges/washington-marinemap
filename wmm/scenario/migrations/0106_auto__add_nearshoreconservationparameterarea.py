...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NearshoreConservationParameterArea'
        db.create_table('scenario_nearshoreconservationparameterarea', (
        ...
        db.send_create_signal('scenario', ['NearshoreConservationParameterArea'])


    def backwards(self, orm):
        
        # Deleting model 'NearshoreConservationParameterArea'
        db.delete_table('scenario_nearshoreconservationparameterarea')
