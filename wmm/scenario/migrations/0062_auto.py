...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field input_geomorphology_offshore_fishing on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_offshore_fishing')

        # Removing M2M table for field input_depth_class_shoreside_development on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_shoreside_development')

        # Removing M2M table for field input_depth_class_wave_energy on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_wave_energy')

        # Removing M2M table for field input_geomorphology_nearshore_conservation on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_nearshore_conservation')

        # Removing M2M table for field input_depth_class_tidal_energy on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_tidal_energy')

        # Removing M2M table for field input_depth_class_wind_energy on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_wind_energy')

        # Removing M2M table for field input_depth_class_shellfish_aquaculture on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_shellfish_aquaculture')

        # Removing M2M table for field input_geomorphology_water_column_conservation on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_water_column_conservation')

        # Removing M2M table for field input_depth_class_water_column_conservation on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_water_column_conservation')

        # Removing M2M table for field input_depth_class_offshore_conservation on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_offshore_conservation')

        # Removing M2M table for field input_geomorphology_offshore_conservation on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_offshore_conservation')

        # Removing M2M table for field input_geomorphology_wind_energy on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_wind_energy')

        # Removing M2M table for field input_geomorphology_tidal_energy on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_tidal_energy')

        # Removing M2M table for field input_geomorphology_shoreside_development on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_shoreside_development')

        # Removing M2M table for field input_depth_class_nearshore_conservation on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_nearshore_conservation')

        # Removing M2M table for field input_depth_class_offshore_fishing on 'Scenario'
        db.delete_table('scenario_scenario_input_depth_class_offshore_fishing')

        # Removing M2M table for field input_geomorphology_shellfish_aquaculture on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_shellfish_aquaculture')

        # Removing M2M table for field input_geomorphology_wave_energy on 'Scenario'
        db.delete_table('scenario_scenario_input_geomorphology_wave_energy')


    def backwards(self, orm):
        
        # Adding M2M table for field input_geomorphology_offshore_fishing on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_offshore_fishing', (
        ...
        db.create_unique('scenario_scenario_input_geomorphology_offshore_fishing', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_shoreside_development on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_shoreside_development', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_shoreside_development', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_depth_class_wave_energy on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_wave_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_wave_energy', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_nearshore_conservation on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_nearshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_nearshore_conservation', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_tidal_energy on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_tidal_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_tidal_energy', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_depth_class_wind_energy on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_wind_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_wind_energy', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_depth_class_shellfish_aquaculture on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_shellfish_aquaculture', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_shellfish_aquaculture', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_water_column_conservation on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_water_column_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_water_column_conservation', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_water_column_conservation on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_water_column_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_water_column_conservation', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_depth_class_offshore_conservation on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_offshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_offshore_conservation', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_offshore_conservation on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_offshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_offshore_conservation', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_geomorphology_wind_energy on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_wind_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_wind_energy', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_geomorphology_tidal_energy on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_tidal_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_tidal_energy', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_geomorphology_shoreside_development on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_shoreside_development', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_shoreside_development', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_depth_class_nearshore_conservation on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_nearshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_nearshore_conservation', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_depth_class_offshore_fishing on 'Scenario'
        db.create_table('scenario_scenario_input_depth_class_offshore_fishing', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('depthclass', models.ForeignKey(orm['scenario.depthclass'], null=False))
        ))
        db.create_unique('scenario_scenario_input_depth_class_offshore_fishing', ['scenario_id', 'depthclass_id'])

        # Adding M2M table for field input_geomorphology_shellfish_aquaculture on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_shellfish_aquaculture', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_shellfish_aquaculture', ['scenario_id', 'geomorphology_id'])

        # Adding M2M table for field input_geomorphology_wave_energy on 'Scenario'
        db.create_table('scenario_scenario_input_geomorphology_wave_energy', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('geomorphology', models.ForeignKey(orm['scenario.geomorphology'], null=False))
        ))
        db.create_unique('scenario_scenario_input_geomorphology_wave_energy', ['scenario_id', 'geomorphology_id'])
