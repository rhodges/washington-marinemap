...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NearshoreEcosystem'
        db.create_table('scenario_nearshoreecosystem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['NearshoreEcosystem'])

        # Adding model 'NearshoreExposure'
        db.create_table('scenario_nearshoreexposure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('scenario', ['NearshoreExposure'])

        # Adding M2M table for field input_exposure_nearshore_conservation on 'MOS'
        db.create_table('scenario_mos_input_exposure_nearshore_conservation', (
        ...
        db.create_unique('scenario_mos_input_exposure_nearshore_conservation', ['mos_id', 'nearshoreexposure_id'])

        # Adding M2M table for field input_ecosystem_nearshore_conservation on 'MOS'
        db.create_table('scenario_mos_input_ecosystem_nearshore_conservation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mos', models.ForeignKey(orm['scenario.mos'], null=False)),
            ('nearshoreecosystem', models.ForeignKey(orm['scenario.nearshoreecosystem'], null=False))
        ))
        db.create_unique('scenario_mos_input_ecosystem_nearshore_conservation', ['mos_id', 'nearshoreecosystem_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NearshoreEcosystem'
        db.delete_table('scenario_nearshoreecosystem')

        # Deleting model 'NearshoreExposure'
        db.delete_table('scenario_nearshoreexposure')

        # Removing M2M table for field input_exposure_nearshore_conservation on 'MOS'
        db.delete_table('scenario_mos_input_exposure_nearshore_conservation')

        # Removing M2M table for field input_ecosystem_nearshore_conservation on 'MOS'
        db.delete_table('scenario_mos_input_ecosystem_nearshore_conservation')
