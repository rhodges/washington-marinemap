...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SMPSite'
        db.create_table('scenario_smpsite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scenario_smpsite_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scenario_smpsite_related', null=True, to=orm['contenttypes.ContentType'])),
        ...
        db.send_create_signal('scenario', ['SMPSite'])

        # Adding M2M table for field sharing_groups on 'SMPSite'
        db.create_table('scenario_smpsite_sharing_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('smpsite', models.ForeignKey(orm['scenario.smpsite'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('scenario_smpsite_sharing_groups', ['smpsite_id', 'group_id'])


    def backwards(self, orm):
        
        # Deleting model 'SMPSite'
        db.delete_table('scenario_smpsite')

        # Removing M2M table for field sharing_groups on 'SMPSite'
        db.delete_table('scenario_smpsite_sharing_groups')
    ...
    models = {
        ...
        'scenario.scenario': {
            ...
            'output_depth_class_stats': ('django.db.models.fields.TextField', [], {'max_length': '360', 'null': 'True', 'blank': 'True'}),
            'output_geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'srid': '32610', 'null': 'True', 'blank': 'True'}),
            'output_geomorphology_stats': ('django.db.models.fields.TextField', [], {'max_length': '360', 'null': 'True', 'blank': 'True'}),
            'output_mapcalc': ('django.db.models.fields.CharField', [], {'max_length': '360', 'null': 'True', 'blank': 'True'}),
            'output_substrate_depth_class_stats': ('django.db.models.fields.TextField', [], {'max_length': '360', 'null': 'True', 'blank': 'True'}),
            'output_substrate_geomorphology_stats': ('django.db.models.fields.TextField', [], {'max_length': '360', 'null': 'True', 'blank': 'True'}),
            'output_substrate_stats': ('django.db.models.fields.TextField', [], {'max_length': '360', 'null': 'True', 'blank': 'True'}),
