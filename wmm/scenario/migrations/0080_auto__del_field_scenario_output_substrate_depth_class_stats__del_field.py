...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scenario.output_substrate_depth_class_stats'
        db.delete_column('scenario_scenario', 'output_substrate_depth_class_stats')

        # Deleting field 'Scenario.output_substrate_geomorphology_stats'
        db.delete_column('scenario_scenario', 'output_substrate_geomorphology_stats')

        # Deleting field 'Scenario.output_geomorphology_stats'
        db.delete_column('scenario_scenario', 'output_geomorphology_stats')

        # Deleting field 'Scenario.output_depth_class_stats'
        db.delete_column('scenario_scenario', 'output_depth_class_stats')

        # Deleting field 'Scenario.output_substrate_stats'
        db.delete_column('scenario_scenario', 'output_substrate_stats')


    def backwards(self, orm):
        
        # Adding field 'Scenario.output_substrate_depth_class_stats'
        db.add_column('scenario_scenario', 'output_substrate_depth_class_stats', self.gf('django.db.models.fields.TextField')(max_length=360, null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.output_substrate_geomorphology_stats'
        db.add_column('scenario_scenario', 'output_substrate_geomorphology_stats', self.gf('django.db.models.fields.TextField')(max_length=360, null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.output_geomorphology_stats'
        db.add_column('scenario_scenario', 'output_geomorphology_stats', self.gf('django.db.models.fields.TextField')(max_length=360, null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.output_depth_class_stats'
        db.add_column('scenario_scenario', 'output_depth_class_stats', self.gf('django.db.models.fields.TextField')(max_length=360, null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.output_substrate_stats'
        db.add_column('scenario_scenario', 'output_substrate_stats', self.gf('django.db.models.fields.TextField')(max_length=360, null=True, blank=True), keep_default=False)
