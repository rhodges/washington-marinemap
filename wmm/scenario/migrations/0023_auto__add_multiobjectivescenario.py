...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scenario_multiobjectivescenario', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scenario_multiobjectivescenario_related', null=True, to=orm['contenttypes.ContentType'])),
    ...
    models = {
        ...
        'scenario.multiobjectivescenario': {
            ...
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_scenarios': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scenario.Scenario']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'255'"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
