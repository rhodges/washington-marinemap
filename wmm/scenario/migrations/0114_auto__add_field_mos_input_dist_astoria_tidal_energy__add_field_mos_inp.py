...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MOS.input_dist_astoria_tidal_energy'
        db.add_column('scenario_mos', 'input_dist_astoria_tidal_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_dist_hoquium_tidal_energy'
        db.add_column('scenario_mos', 'input_dist_hoquium_tidal_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_dist_astoria_wind_energy'
        db.add_column('scenario_mos', 'input_dist_astoria_wind_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_dist_hoquium_wind_energy'
        db.add_column('scenario_mos', 'input_dist_hoquium_wind_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_dist_astoria_wave_energy'
        db.add_column('scenario_mos', 'input_dist_astoria_wave_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MOS.input_dist_hoquium_wave_energy'
        db.add_column('scenario_mos', 'input_dist_hoquium_wave_energy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_dist_astoria'
        db.add_column('scenario_scenario', 'input_dist_astoria', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_dist_hoquium'
        db.add_column('scenario_scenario', 'input_dist_hoquium', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MOS.input_dist_astoria_tidal_energy'
        db.delete_column('scenario_mos', 'input_dist_astoria_tidal_energy')

        # Deleting field 'MOS.input_dist_hoquium_tidal_energy'
        db.delete_column('scenario_mos', 'input_dist_hoquium_tidal_energy')

        # Deleting field 'MOS.input_dist_astoria_wind_energy'
        db.delete_column('scenario_mos', 'input_dist_astoria_wind_energy')

        # Deleting field 'MOS.input_dist_hoquium_wind_energy'
        db.delete_column('scenario_mos', 'input_dist_hoquium_wind_energy')

        # Deleting field 'MOS.input_dist_astoria_wave_energy'
        db.delete_column('scenario_mos', 'input_dist_astoria_wave_energy')

        # Deleting field 'MOS.input_dist_hoquium_wave_energy'
        db.delete_column('scenario_mos', 'input_dist_hoquium_wave_energy')

        # Deleting field 'Scenario.input_dist_astoria'
        db.delete_column('scenario_scenario', 'input_dist_astoria')

        # Deleting field 'Scenario.input_dist_hoquium'
        db.delete_column('scenario_scenario', 'input_dist_hoquium')
