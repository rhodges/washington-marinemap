...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'scenario.scenario': {
            ...
            'input_substrate_nearshore_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.NearshoreConservationSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_offshore_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.OffshoreConservationSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_offshore_fishing': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.OffshoreFishingSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_shellfish_aquaculture': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.ShellfishAquacultureSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_shoreside_development': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.ShoresideDevelopmentSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_tidal_energy': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.TidalEnergySubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_water_column_conservation': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.WaterColumnConservationSubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_wave_energy': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.WaveEnergySubstrate']", 'null': 'True', 'blank': 'True'}),
            'input_substrate_wind_energy': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenario.WindEnergySubstrate']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'255'"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
