...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.output_geom'
        db.alter_column('scenario_scenario', 'output_geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=32610, null=True))


    def backwards(self, orm):
        
        # Changing field 'Scenario.output_geom'
        db.alter_column('scenario_scenario', 'output_geom', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=32610, null=True))
