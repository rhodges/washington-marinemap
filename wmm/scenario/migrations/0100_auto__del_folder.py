...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('scenario_folder')

        # Removing M2M table for field sharing_groups on 'Folder'
        db.delete_table('scenario_folder_sharing_groups')


    def backwards(self, orm):
        
        # Adding model 'Folder'
        db.create_table('scenario_folder', (
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scenario_folder_related', null=True, to=orm['contenttypes.ContentType'], blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scenario_folder_related', to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
        ))
        db.send_create_signal('scenario', ['Folder'])

        # Adding M2M table for field sharing_groups on 'Folder'
        db.create_table('scenario_folder_sharing_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('folder', models.ForeignKey(orm['scenario.folder'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('scenario_folder_sharing_groups', ['folder_id', 'group_id'])
