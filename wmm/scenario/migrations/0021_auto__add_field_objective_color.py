...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Objective.color'
        db.add_column('scenario_objective', 'color', self.gf('django.db.models.fields.CharField')(default='778B1A55', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Objective.color'
        db.delete_column('scenario_objective', 'color')
