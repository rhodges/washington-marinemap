...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MOS.input_substrate_tidal_energy'
        db.add_column('scenario_mos', 'input_substrate_tidal_energy', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='TidalEnergySubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_wind_energy'
        db.add_column('scenario_mos', 'input_substrate_wind_energy', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='WindEnergySubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_wave_energy'
        db.add_column('scenario_mos', 'input_substrate_wave_energy', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='WaveEnergySubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_offshore_conservation'
        db.add_column('scenario_mos', 'input_substrate_offshore_conservation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='OffshoreConservationSubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_nearshore_conservation'
        db.add_column('scenario_mos', 'input_substrate_nearshore_conservation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='NearshoreConservationSubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_water_column_conservation'
        db.add_column('scenario_mos', 'input_substrate_water_column_conservation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='WaterColumnConservationSubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_shoreside_development'
        db.add_column('scenario_mos', 'input_substrate_shoreside_development', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ShoresideDevelopmentSubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_shellfish_aquaculture'
        db.add_column('scenario_mos', 'input_substrate_shellfish_aquaculture', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ShellfishAquacultureSubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)

        # Adding field 'MOS.input_substrate_offshore_fishing'
        db.add_column('scenario_mos', 'input_substrate_offshore_fishing', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='OffshoreFishingSubstrate', null=True, to=orm['scenario.Substrate']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MOS.input_substrate_tidal_energy'
        db.delete_column('scenario_mos', 'input_substrate_tidal_energy_id')

        # Deleting field 'MOS.input_substrate_wind_energy'
        db.delete_column('scenario_mos', 'input_substrate_wind_energy_id')

        # Deleting field 'MOS.input_substrate_wave_energy'
        db.delete_column('scenario_mos', 'input_substrate_wave_energy_id')

        # Deleting field 'MOS.input_substrate_offshore_conservation'
        db.delete_column('scenario_mos', 'input_substrate_offshore_conservation_id')

        # Deleting field 'MOS.input_substrate_nearshore_conservation'
        db.delete_column('scenario_mos', 'input_substrate_nearshore_conservation_id')

        # Deleting field 'MOS.input_substrate_water_column_conservation'
        db.delete_column('scenario_mos', 'input_substrate_water_column_conservation_id')

        # Deleting field 'MOS.input_substrate_shoreside_development'
        db.delete_column('scenario_mos', 'input_substrate_shoreside_development_id')

        # Deleting field 'MOS.input_substrate_shellfish_aquaculture'
        db.delete_column('scenario_mos', 'input_substrate_shellfish_aquaculture_id')

        # Deleting field 'MOS.input_substrate_offshore_fishing'
        db.delete_column('scenario_mos', 'input_substrate_offshore_fishing_id')
    ...
    models = {
        ...
        'scenario.mos': {
            ...
            'input_substrate_nearshore_conservation': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'NearshoreConservationSubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_offshore_conservation': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'OffshoreConservationSubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_offshore_fishing': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'OffshoreFishingSubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_shellfish_aquaculture': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ShellfishAquacultureSubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_shoreside_development': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ShoresideDevelopmentSubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_tidal_energy': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'TidalEnergySubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_water_column_conservation': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'WaterColumnConservationSubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_wave_energy': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'WaveEnergySubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'input_substrate_wind_energy': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'WindEnergySubstrate'", 'null': 'True', 'to': "orm['scenario.Substrate']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'255'"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
