...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field input_nearshore_substrate on 'Scenario'
        db.create_table('scenario_scenario_input_nearshore_substrate', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenario.scenario'], null=False)),
            ('nearshoresubstrate', models.ForeignKey(orm['scenario.nearshoresubstrate'], null=False))
        ))
        db.create_unique('scenario_scenario_input_nearshore_substrate', ['scenario_id', 'nearshoresubstrate_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field input_nearshore_substrate on 'Scenario'
        db.delete_table('scenario_scenario_input_nearshore_substrate')
