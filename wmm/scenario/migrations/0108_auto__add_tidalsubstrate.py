...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field input_tidal_substrate on 'Scenario'
        db.create_table('scenario_scenario_input_tidal_substrate', (
        ...
        db.create_unique('scenario_scenario_input_tidal_substrate', ['scenario_id', 'tidalsubstrate_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field input_tidal_substrate on 'Scenario'
        db.delete_table('scenario_scenario_input_tidal_substrate')
