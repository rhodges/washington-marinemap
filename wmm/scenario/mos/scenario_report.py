...
def get_scenario_context(mos, scenario): 
    ...
    substrate_table_height = 50 * len(substrate_stats.keys())
    context = {'default_value': default_value, 'mos': mos, 'scenario': scenario, 'substrate_jstats': substrate_jstats, 'substrate_table_height': substrate_table_height}
    return context
