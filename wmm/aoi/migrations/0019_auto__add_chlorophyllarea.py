...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChlorophyllArea'
        db.create_table('aoi_chlorophyllarea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('aoi', ['ChlorophyllArea'])


    def backwards(self, orm):
        
        # Deleting model 'ChlorophyllArea'
        db.delete_table('aoi_chlorophyllarea')
