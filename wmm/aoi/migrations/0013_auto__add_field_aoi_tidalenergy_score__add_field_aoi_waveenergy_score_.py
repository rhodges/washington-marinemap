...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AOI.tidalenergy_score'
        db.add_column('aoi_aoi', 'tidalenergy_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AOI.waveenergy_score'
        db.add_column('aoi_aoi', 'waveenergy_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'AOI.windenergy_score'
        db.add_column('aoi_aoi', 'windenergy_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AOI.tidalenergy_score'
        db.delete_column('aoi_aoi', 'tidalenergy_score')

        # Deleting field 'AOI.waveenergy_score'
        db.delete_column('aoi_aoi', 'waveenergy_score')

        # Deleting field 'AOI.windenergy_score'
        db.delete_column('aoi_aoi', 'windenergy_score')
