...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TidalSubstrateArea'
        db.create_table('aoi_tidalsubstratearea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gridcode', self.gf('django.db.models.fields.IntegerField')()),
            ('area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('aoi', ['TidalSubstrateArea'])

        # Adding model 'TidalSubstrate'
        db.create_table('aoi_tidalsubstrate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gridcode', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=32610, null=True, blank=True)),
        ))
        db.send_create_signal('aoi', ['TidalSubstrate'])


    def backwards(self, orm):
        
        # Deleting model 'TidalSubstrateArea'
        db.delete_table('aoi_tidalsubstratearea')

        # Deleting model 'TidalSubstrate'
        db.delete_table('aoi_tidalsubstrate')
