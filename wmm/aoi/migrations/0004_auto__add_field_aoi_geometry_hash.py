...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AOI.geometry_hash'
        db.add_column('aoi_aoi', 'geometry_hash', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AOI.geometry_hash'
        db.delete_column('aoi_aoi', 'geometry_hash')


    models = {
        'aoi.aoi': {
            'Meta': {'object_name': 'AOI'},
            'benthic_score': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'geometry_hash': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
