...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sponge.common_nam'
        db.alter_column('aoi_sponge', 'common_nam', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))


    def backwards(self, orm):
        
        # Changing field 'Sponge.common_nam'
        db.alter_column('aoi_sponge', 'common_nam', self.gf('django.db.models.fields.CharField')(max_length=24))
