...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AOI.geometry_hash'
        db.alter_column('aoi_aoi', 'geometry_hash', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'AOI.geometry_hash'
        db.alter_column('aoi_aoi', 'geometry_hash', self.gf('django.db.models.fields.FloatField')(null=True))
