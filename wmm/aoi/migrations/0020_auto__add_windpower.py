...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WindPower'
        db.create_table('aoi_windpower', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wpc', self.gf('django.db.models.fields.FloatField')()),
            ('potential', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('densitywm2', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('speed_ms', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('speed_mph', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=32610, null=True, blank=True)),
        ))
        db.send_create_signal('aoi', ['WindPower'])


    def backwards(self, orm):
        
        # Deleting model 'WindPower'
        db.delete_table('aoi_windpower')
