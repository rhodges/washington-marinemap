...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BenthicSubstrateCache'
        db.create_table('aoi_benthicsubstratecache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wkt_hash', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('report', self.gf('picklefield.fields.PickledObjectField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('aoi', ['BenthicSubstrateCache'])

        # Adding model 'BenthicDepthCache'
        db.create_table('aoi_benthicdepthcache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wkt_hash', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('report', self.gf('picklefield.fields.PickledObjectField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('aoi', ['BenthicDepthCache'])

        # Adding model 'BenthicGeomorphCache'
        db.create_table('aoi_benthicgeomorphcache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wkt_hash', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('report', self.gf('picklefield.fields.PickledObjectField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('aoi', ['BenthicGeomorphCache'])


    def backwards(self, orm):
        
        # Deleting model 'BenthicSubstrateCache'
        db.delete_table('aoi_benthicsubstratecache')

        # Deleting model 'BenthicDepthCache'
        db.delete_table('aoi_benthicdepthcache')

        # Deleting model 'BenthicGeomorphCache'
        db.delete_table('aoi_benthicgeomorphcache')
    ...
    models = {
        ...
        'aoi.benthicdepthcache': {
            'Meta': {'object_name': 'BenthicDepthCache'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'aoi.benthicgeomorphcache': {
            'Meta': {'object_name': 'BenthicGeomorphCache'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('picklefield.fields.PickledObjectField', [], {}),
        ...
        'aoi.benthicsubstratecache': {
            'Meta': {'object_name': 'BenthicSubstrateCache'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('picklefield.fields.PickledObjectField', [], {}),
