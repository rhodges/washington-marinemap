...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'OffshoreScoring'
        db.delete_table('aoi_offshorescoring')

        # Adding model 'ConservationScoring'
        db.create_table('aoi_conservationscoring', (
        ...
        db.send_create_signal('aoi', ['ConservationScoring'])

        # Deleting field 'AOI.benthic_score'
        db.delete_column('aoi_aoi', 'benthic_score')

        # Adding field 'AOI.conservation_score'
        db.add_column('aoi_aoi', 'conservation_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'OffshoreScoring'
        db.create_table('aoi_offshorescoring', (
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=32610, null=True, blank=True)),
            ('score', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('aoi', ['OffshoreScoring'])

        # Deleting model 'ConservationScoring'
        db.delete_table('aoi_conservationscoring')

        # Adding field 'AOI.benthic_score'
        db.add_column('aoi_aoi', 'benthic_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'AOI.conservation_score'
        db.delete_column('aoi_aoi', 'conservation_score')
