...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('aoi_aoishapefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=32610, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('aoi_id_num', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('aoi', self.gf('django.db.models.fields.related.OneToOneField')(related_name='aoi', unique=True, to=orm['aoi.AOI'])),
            ('aoi_modification_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('aoi', ['AOIShapefile'])


    def backwards(self, orm):
        
        # Deleting model 'AOIShapefile'
        db.delete_table('aoi_aoishapefile')
    ...
    models = {
        ...
        'aoi.aoishapefile': {
            ...
            'aoi': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'aoi'", 'unique': 'True', 'to': "orm['aoi.AOI']"}),
            ...
            'geometry': ('django.contrib.gis.db.models.fields.PolygonField', [], {'srid': '32610', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
