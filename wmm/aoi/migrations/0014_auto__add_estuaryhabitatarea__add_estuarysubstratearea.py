...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EstuaryHabitatArea'
        db.create_table('aoi_estuaryhabitatarea', (
        ...
        db.send_create_signal('aoi', ['EstuaryHabitatArea'])

        # Adding model 'EstuarySubstrateArea'
        db.create_table('aoi_estuarysubstratearea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('substrate', self.gf('django.db.models.fields.CharField')(max_length=29)),
            ('area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('aoi', ['EstuarySubstrateArea'])


    def backwards(self, orm):
        
        # Deleting model 'EstuaryHabitatArea'
        db.delete_table('aoi_estuaryhabitatarea')

        # Deleting model 'EstuarySubstrateArea'
        db.delete_table('aoi_estuarysubstratearea')
