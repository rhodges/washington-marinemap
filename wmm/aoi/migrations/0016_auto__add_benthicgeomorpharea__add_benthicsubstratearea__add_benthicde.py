...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BenthicGeomorphArea'
        db.create_table('aoi_benthicgeomorpharea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geomorph', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('aoi', ['BenthicGeomorphArea'])

        # Adding model 'BenthicSubstrateArea'
        db.create_table('aoi_benthicsubstratearea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('substrate', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('aoi', ['BenthicSubstrateArea'])

        # Adding model 'BenthicDepthArea'
        db.create_table('aoi_benthicdeptharea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('depth', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('aoi', ['BenthicDepthArea'])


    def backwards(self, orm):
        
        # Deleting model 'BenthicGeomorphArea'
        db.delete_table('aoi_benthicgeomorpharea')

        # Deleting model 'BenthicSubstrateArea'
        db.delete_table('aoi_benthicsubstratearea')

        # Deleting model 'BenthicDepthArea'
        db.delete_table('aoi_benthicdeptharea')
