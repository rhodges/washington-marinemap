...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AOI.benthic_score'
        db.alter_column('aoi_aoi', 'benthic_score', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'AOI.benthic_score'
        db.alter_column('aoi_aoi', 'benthic_score', self.gf('django.db.models.fields.FloatField')(null=True))


    models = {
        'aoi.aoi': {
            'Meta': {'object_name': 'AOI'},
            'benthic_score': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'geometry_hash': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'aoi.offshorescoring': {
            'Meta': {'object_name': 'OffshoreScoring'},
