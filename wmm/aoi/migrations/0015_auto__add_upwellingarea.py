...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UpwellingArea'
        db.create_table('aoi_upwellingarea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('area', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('aoi', ['UpwellingArea'])


    def backwards(self, orm):
        
        # Deleting model 'UpwellingArea'
        db.delete_table('aoi_upwellingarea')
